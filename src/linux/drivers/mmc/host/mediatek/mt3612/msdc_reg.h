...
/* AES-XTS engine ergister */
#define OFFSET_MSDC_AES_SEL		(0x280)
#define OFFSET_MSDC_AES_EN		(0x600)
#define OFFSET_MSDC_AES_CFG_GP0		(0x604)
#define OFFSET_MSDC_AES_IV0_GP0		(0x610)
#define OFFSET_MSDC_AES_IV1_GP0		(0x614)
#define OFFSET_MSDC_AES_IV2_GP0		(0x618)
#define OFFSET_MSDC_AES_IV3_GP0		(0x61C)
#define OFFSET_MSDC_AES_CTR0_GP0	(0x620)
#define OFFSET_MSDC_AES_CTR1_GP0	(0x624)
#define OFFSET_MSDC_AES_CTR2_GP0	(0x628)
#define OFFSET_MSDC_AES_CTR3_GP0	(0x62C)
#define OFFSET_MSDC_AES_KEY0_GP0	(0x630)
#define OFFSET_MSDC_AES_KEY1_GP0	(0x634)
#define OFFSET_MSDC_AES_KEY2_GP0	(0x638)
#define OFFSET_MSDC_AES_KEY3_GP0	(0x63C)
#define OFFSET_MSDC_AES_KEY4_GP0	(0x640)
#define OFFSET_MSDC_AES_KEY5_GP0	(0x644)
#define OFFSET_MSDC_AES_KEY6_GP0	(0x648)
#define OFFSET_MSDC_AES_KEY7_GP0	(0x64C)
#define OFFSET_MSDC_AES_TKEY0_GP0	(0x650)
#define OFFSET_MSDC_AES_TKEY1_GP0	(0x654)
#define OFFSET_MSDC_AES_TKEY2_GP0	(0x658)
#define OFFSET_MSDC_AES_TKEY3_GP0	(0x65C)
#define OFFSET_MSDC_AES_TKEY4_GP0	(0x660)
#define OFFSET_MSDC_AES_TKEY5_GP0	(0x664)
#define OFFSET_MSDC_AES_TKEY6_GP0	(0x668)
#define OFFSET_MSDC_AES_TKEY7_GP0	(0x66C)
#define OFFSET_MSDC_AES_SWST		(0x670)
#define OFFSET_MSDC_AES_CFG_GP1		(0x674)
#define OFFSET_MSDC_AES_IV0_GP1		(0x680)
#define OFFSET_MSDC_AES_IV1_GP1		(0x684)
#define OFFSET_MSDC_AES_IV2_GP1		(0x688)
#define OFFSET_MSDC_AES_IV3_GP1		(0x68C)
#define OFFSET_MSDC_AES_CTR0_GP1	(0x690)
#define OFFSET_MSDC_AES_CTR1_GP1	(0x694)
#define OFFSET_MSDC_AES_CTR2_GP1	(0x698)
#define OFFSET_MSDC_AES_CTR3_GP1	(0x69C)
#define OFFSET_MSDC_AES_KEY0_GP1	(0x6A0)
#define OFFSET_MSDC_AES_KEY1_GP1	(0x6A4)
#define OFFSET_MSDC_AES_KEY2_GP1	(0x6A8)
#define OFFSET_MSDC_AES_KEY3_GP1	(0x6AC)
#define OFFSET_MSDC_AES_KEY4_GP1	(0x6B0)
#define OFFSET_MSDC_AES_KEY5_GP1	(0x6B4)
#define OFFSET_MSDC_AES_KEY6_GP1	(0x6B8)
#define OFFSET_MSDC_AES_KEY7_GP1	(0x6BC)
#define OFFSET_MSDC_AES_TKEY0_GP1	(0x6C0)
#define OFFSET_MSDC_AES_TKEY1_GP1	(0x6C4)
#define OFFSET_MSDC_AES_TKEY2_GP1	(0x6C8)
#define OFFSET_MSDC_AES_TKEY3_GP1	(0x6CC)
#define OFFSET_MSDC_AES_TKEY4_GP1	(0x6D0)
#define OFFSET_MSDC_AES_TKEY5_GP1	(0x6D4)
#define OFFSET_MSDC_AES_TKEY6_GP1	(0x6D8)
#define OFFSET_MSDC_AES_TKEY7_GP1	(0x6DC)

/* Multi host register */
#define OFFSET_EMMC_MTH_CFG		(0xA00)
#define OFFSET_EMMC_MTH_ST		(0xA04)
#define OFFSET_EMMC_MTH_PARMAP0		(0xA08)
#define OFFSET_EMMC_MTH_PARMAP1		(0xA0C)
#define OFFSET_EMMC_MTH_PARMAP2		(0xA10)
#define OFFSET_EMMC_MTH_PARMAP3		(0xA14)
#define OFFSET_EMMC_MTH_TK_CTRL0	(0xA18)
#define OFFSET_EMMC_MTH_TK_CTRL1	(0xA1C)
#define OFFSET_EMMC_MTH_TK_CTRL2	(0xA20)
#define OFFSET_EMMC_MTH_TK_CTRL3	(0xA24)
#define OFFSET_EMMC_MTH_IT_SET1		(0xA28)
...
/* AES-XTS register */
#define MSDC_AES_EN			REG_ADDR(MSDC_AES_EN)
#define MSDC_AES_CFG_GP0		REG_ADDR(MSDC_AES_CFG_GP0)
#define MSDC_AES_IV0_GP0		REG_ADDR(MSDC_AES_IV0_GP0)
#define MSDC_AES_IV1_GP0		REG_ADDR(MSDC_AES_IV1_GP0)
#define MSDC_AES_IV2_GP0		REG_ADDR(MSDC_AES_IV2_GP0)
#define MSDC_AES_IV3_GP0		REG_ADDR(MSDC_AES_IV3_GP0)
#define MSDC_AES_CTR0_GP0		REG_ADDR(MSDC_AES_CTR0_GP0)
#define MSDC_AES_CTR1_GP0		REG_ADDR(MSDC_AES_CTR1_GP0)
#define MSDC_AES_CTR2_GP0		REG_ADDR(MSDC_AES_CTR2_GP0)
#define MSDC_AES_CTR3_GP0		REG_ADDR(MSDC_AES_CTR3_GP0)
#define MSDC_AES_KEY0_GP0		REG_ADDR(MSDC_AES_KEY0_GP0)
#define MSDC_AES_KEY1_GP0		REG_ADDR(MSDC_AES_KEY1_GP0)
#define MSDC_AES_KEY2_GP0		REG_ADDR(MSDC_AES_KEY2_GP0)
#define MSDC_AES_KEY3_GP0		REG_ADDR(MSDC_AES_KEY3_GP0)
#define MSDC_AES_KEY4_GP0		REG_ADDR(MSDC_AES_KEY4_GP0)
#define MSDC_AES_KEY5_GP0		REG_ADDR(MSDC_AES_KEY5_GP0)
#define MSDC_AES_KEY6_GP0		REG_ADDR(MSDC_AES_KEY6_GP0)
#define MSDC_AES_KEY7_GP0		REG_ADDR(MSDC_AES_KEY7_GP0)
#define MSDC_AES_TKEY0_GP0		REG_ADDR(MSDC_AES_TKEY0_GP0)
#define MSDC_AES_TKEY1_GP0		REG_ADDR(MSDC_AES_TKEY1_GP0)
#define MSDC_AES_TKEY2_GP0		REG_ADDR(MSDC_AES_TKEY2_GP0)
#define MSDC_AES_TKEY3_GP0		REG_ADDR(MSDC_AES_TKEY3_GP0)
#define MSDC_AES_TKEY4_GP0		REG_ADDR(MSDC_AES_TKEY4_GP0)
#define MSDC_AES_TKEY5_GP0		REG_ADDR(MSDC_AES_TKEY5_GP0)
#define MSDC_AES_TKEY6_GP0		REG_ADDR(MSDC_AES_TKEY6_GP0)
#define MSDC_AES_TKEY7_GP0		REG_ADDR(MSDC_AES_TKEY7_GP0)
#define MSDC_AES_SWST			REG_ADDR(MSDC_AES_SWST)
#define MSDC_AES_CFG_GP1		REG_ADDR(MSDC_AES_CFG_GP1)
#define MSDC_AES_IV0_GP1		REG_ADDR(MSDC_AES_IV0_GP1)
#define MSDC_AES_IV1_GP1		REG_ADDR(MSDC_AES_IV1_GP1)
#define MSDC_AES_IV2_GP1		REG_ADDR(MSDC_AES_IV2_GP1)
#define MSDC_AES_IV3_GP1		REG_ADDR(MSDC_AES_IV3_GP1)
#define MSDC_AES_CTR0_GP1		REG_ADDR(MSDC_AES_CTR0_GP1)
#define MSDC_AES_CTR1_GP1		REG_ADDR(MSDC_AES_CTR1_GP1)
#define MSDC_AES_CTR2_GP1		REG_ADDR(MSDC_AES_CTR2_GP1)
#define MSDC_AES_CTR3_GP1		REG_ADDR(MSDC_AES_CTR3_GP1)
#define MSDC_AES_KEY0_GP1		REG_ADDR(MSDC_AES_KEY0_GP1)
#define MSDC_AES_KEY1_GP1		REG_ADDR(MSDC_AES_KEY1_GP1)
#define MSDC_AES_KEY2_GP1		REG_ADDR(MSDC_AES_KEY2_GP1)
#define MSDC_AES_KEY3_GP1		REG_ADDR(MSDC_AES_KEY3_GP1)
#define MSDC_AES_KEY4_GP1		REG_ADDR(MSDC_AES_KEY4_GP1)
#define MSDC_AES_KEY5_GP1		REG_ADDR(MSDC_AES_KEY5_GP1)
#define MSDC_AES_KEY6_GP1		REG_ADDR(MSDC_AES_KEY6_GP1)
#define MSDC_AES_KEY7_GP1		REG_ADDR(MSDC_AES_KEY7_GP1)
#define MSDC_AES_TKEY0_GP1		REG_ADDR(MSDC_AES_TKEY0_GP1)
#define MSDC_AES_TKEY1_GP1		REG_ADDR(MSDC_AES_TKEY1_GP1)
#define MSDC_AES_TKEY2_GP1		REG_ADDR(MSDC_AES_TKEY2_GP1)
#define MSDC_AES_TKEY3_GP1		REG_ADDR(MSDC_AES_TKEY3_GP1)
#define MSDC_AES_TKEY4_GP1		REG_ADDR(MSDC_AES_TKEY4_GP1)
#define MSDC_AES_TKEY5_GP1		REG_ADDR(MSDC_AES_TKEY5_GP1)
#define MSDC_AES_TKEY6_GP1		REG_ADDR(MSDC_AES_TKEY6_GP1)
#define MSDC_AES_TKEY7_GP1		REG_ADDR(MSDC_AES_TKEY7_GP1)
...
#define SDC_CMD_STS_RX_ENHANCE_EN (0x1  << 20)
...
/* MSDC AES_EN mask */
#define AES_EN							(0x1<<0)
#define AES_SWITCH_VALID0				(0x1<<1)
#define AES_SWITCH_VALID1				(0x1<<2)
#define AES_KEY_SWAP					(0x1<<3)
#define AES_CLKDIVSEL					(0x7<<4)

/* MSDC AES_CFG_GP0 */
#define AESMD0					(0x1F<<0)
#define AES_KEY_SIZE0				(0x3<<8)
#define AES_DECRYPT0				(0x1<<12)
#define AES_DATA_UNIT_SIZE0			(0x1FF<<16)
#define AES_DATA_UNIT_SIZE_512_BYTE		(0x200<<16)	/* RW */
#define AES_KEY_SIZE_128_BIT			(0<<8)		/* RW */
#define AES_KEY_SIZE_192_BIT			(0x1<<8)	/* RW */
#define AES_KEY_SIZE_256_BIT			(0x2<<8)	/* RW */
#define AES_MODE_XTS				0x04		/* RW */

/* MSDC AES_IV0_GP0 */
#define AES_IV0_GP0						(0xFFFFFFFF<<0)

/* MSDC AES_IV1_GP0 */
#define AES_IV1_GP0						(0xFFFFFFFF<<0)

/* MSDC AES_IV2_GP0 */
#define AES_IV2_GP0						(0xFFFFFFFF<<0)

/* MSDC AES_IV3_GP0 */
#define AES_IV3_GP0						(0xFFFFFFFF<<0)

/* MSDC AES_CTR0_GP0 */
#define AES_CTR0_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_CTR1_GP0 */
#define AES_CTR1_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_CTR2_GP0 */
#define AES_CTR2_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_CTR3_GP0 */
#define AES_CTR3_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY0_GP0 */
#define AES_KEY0_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY1_GP0 */
#define AES_KEY1_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY2_GP0 */
#define AES_KEY2_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY3_GP0 */
#define AES_KEY3_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY4_GP0 */
#define AES_KEY4_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY5_GP0 */
#define AES_KEY5_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY6_GP0 */
#define AES_KEY6_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_KEY7_GP0 */
#define AES_KEY7_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY0_GP0 */
#define AES_TKEY0_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY1_GP0 */
#define AES_TKEY1_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY2_GP0 */
#define AES_TKEY2_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY3_GP0 */
#define AES_TKEY3_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY4_GP0 */
#define AES_TKEY4_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY5_GP0 */
#define AES_TKEY5_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY6_GP0 */
#define AES_TKEY6_GP0					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY7_GP0 */
#define AES_TKEY7_GP0					(0xFFFFFFFF<<0)
...
/* MSDC AES_IV0_GP1 */
#define AES_IV0_GP1						(0xFFFFFFFF<<0)

/* MSDC AES_IV1_GP1 */
#define AES_IV1_GP1						(0xFFFFFFFF<<0)

/* MSDC AES_IV2_GP1 */
#define AES_IV2_GP1						(0xFFFFFFFF<<0)

/* MSDC AES_IV3_GP1 */
#define AES_IV3_GP1						(0xFFFFFFFF<<0)

/* MSDC AES_CTR0_GP1 */
#define AES_CTR0_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_CTR1_GP1 */
#define AES_CTR1_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_CTR2_GP1 */
#define AES_CTR2_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_CTR3_GP1 */
#define AES_CTR3_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY0_GP1 */
#define AES_KEY0_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY1_GP1 */
#define AES_KEY1_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY2_GP1 */
#define AES_KEY2_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY3_GP1 */
#define AES_KEY3_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY4_GP1 */
#define AES_KEY4_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY5_GP1 */
#define AES_KEY5_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY6_GP1 */
#define AES_KEY6_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_KEY7_GP1 */
#define AES_KEY7_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY0_GP1 */
#define AES_TKEY0_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY1_GP1 */
#define AES_TKEY1_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY2_GP1 */
#define AES_TKEY2_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY3_GP1 */
#define AES_TKEY3_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY4_GP1 */
#define AES_TKEY4_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY5_GP1 */
#define AES_TKEY5_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY6_GP1 */
#define AES_TKEY6_GP1					(0xFFFFFFFF<<0)

/* MSDC AES_TKEY7_GP1 */
#define AES_TKEY7_GP1					(0xFFFFFFFF<<0)
 ...
 *MSDC TOP REG
 */
/* #define MSDC_TOP_BASE                   (0x11c00000) */
/* TOP REGISTER */
