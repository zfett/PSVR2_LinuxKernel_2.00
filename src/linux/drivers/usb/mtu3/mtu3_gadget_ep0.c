...
/**
 * @file mtu3_gadget_ep0.c
 *
 *  USB API for MediaTek USB3 DRD peripheral driver ep0 handling
 *
 */
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     Forward the request to the upper class driver.
 * @param[out]
 *     mtu: mtu3 structure
 * @param[in]
 *     setup: usb control request
 * @return
 ...
 *     EP0 set stall.
 * @param[out]
 *     mep0: mtu3 end point structure
 * @param[in]
 *     set: SEND STALL
 * @param[in]
 *     pktrdy: EP0 setup packet ready
 * @return
 *     none
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 set sel complete.
 * @param[in]
 *     ep: usb end point structure
 * @param[in]
 *     req: usb request structure
 * @return
 *     none
 ...
 * @param[in]
 *     setup: SETUP data for a USB device control request structure
 * @return
 *     ret, status of ep0_queue.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 *     none
 ...
 *     setup: SETUP data for a USB device control request structure
 * @return
 *     handled, status of ep0_get_status.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 handle test mode.
 * @param[out]
 *     mtu: device driver instance data structure
 * @param[in]
 *     setup: SETUP data for a USB device control request structure
 * @return
 *     handled, status of handle_test_mode.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 handle feature device.
 * @param[out]
 *     mtu: device driver instance data structure
 * @param[in]
 *     setup: SETUP data for a USB device control request structure
 * @return
 *     handled, status of ep0_handle_feature_dev.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 handle CLEAR_FEATURE / SET_FEATURE.
 * @param[out]
 *     mtu: device driver instance data structure
 * @param[in]
 *     setup: SETUP data for a USB device control request structure
 ...
 *     set: set flag
 * @return
 *     handled, status of ep0_handle_feature.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 handle standard request.
 * @param[out]
 *     mtu: device driver instance data structure
 * @param[in]
 *     setup: SETUP data for a USB device control request structure
 * @return
 *     handled, status of handle_standard_request.\n
 *     If return value is negative error number, means error happened.\n
 *     If return value is zero, means need delegate SETUP to gadget driver.\n
 *     If return value is positive, means already handled.
 * @par Boundary case and limitation
			  ...
			  struct usb_ctrlrequest *setup)
{
	...
	case USB_REQ_SET_ADDRESS:
		...
		dev_warn(mtu->dev, "set address to 0x%x\n", mtu->address);
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 rx state-receive an data packet (OUT).
 * @param[out]
 *     mtu: device driver instance data structure
 * @return
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     EP0 tx state-transmitting to the host (IN).
 * @param[out]
 *     mtu: device driver instance data structure
 * @return
 *     none
...
stall:
		...
		/* Avoid sendstall before Control OUT data stage */
 ...
 *     IRQ_NONE, means that IRQ_NONE means we didn't handle it.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB3 IP ep0 queue function.
 * @param[in]
 *     ep: usb end point structure
 * @param[out]
 *     req: mtu3 request structure
 * @param[in]
 *     gfp: no used
 * @return
 *     0, means SUCCESS.\n
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB3 IP ep0 dequeue function,we just won't support this.
 * @param[in]
 *     ep: usb end point structure
 * @param[in]
 *     req: mtu3 request structure
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB3 IP sets ep0 halt feature.
 * @param[in]
 *     ep: usb end point structure
 * @param[in]
 *     value: request halt
