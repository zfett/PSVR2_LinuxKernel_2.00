 ...
 * @file mtu3_qmu.c
 *
 *  USB API of Queue Management Unit driver for device controller
 *
 */
 ...
 * @par Description
 *     gpd physical address to virtual address.
 * @param[in]
 *     ring: mtu3 gpd ring structure
 * @param[in]
 *     dma_addr: physical address of GPD segment
 * @return
 *     gpd_head + offset, virtual address.\n
 *     NULL, means that we didn't handle it.
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     gpd virtual address to physical address.
 * @param[in]
 *     ring: mtu3 gpd ring structure
 * @param[in]
 *     dma_addr: physical address of GPD segment
 * @return
 *     dma_base + (offset * sizeof(*gpd)), dma address.\n
 *     0, it means over MAX_GPD_NUM.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB check if a ring is emtpy.
 * @param[in]
 *     mep: mtu3 end point structure
 * @return
 *     1, means empty.\n
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     Depend on direction, MTK USB prepare gpd.
 * @param[out]
 *     mep: mtu3 end point structure
 * @param[out]
 *     mreq: mtu3 request structure
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     qmu tx zlp error handler function.
 * @param[in]
 *     mtu: mtu3 structure
 * @param[in]
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     Depend on end point, process qmu done isr function.
 * @param[in]
 *     mtu: mtu3 structure
 * @param[in]
 *     done_status: ISR done status
 * @return
 *     none
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     qmu exception isr function.
 * @param[in]
 *     mtu: mtu3 structure
 * @param[in]
 *     qmu_status: QMU status
 * @return
 *     none
 * @par Boundary case and limitation
 *     none
