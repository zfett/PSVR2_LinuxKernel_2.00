 ...
 * @file mtu3_dr.c
 *
 *  USB API for dual role switch and host glue layer
 *
 */
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     port0 switch for dual-role mode.
 * @param[in]
 *     ssusb: ssusb_mtk structure
 * @param[in]
 *     version: USB2_PORT or USB3_PORT
 * @param[in]
 *     tohost: true or false
 * @return
 *     0, means SUCCESS.
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     usb mode manual switch.
 * @param[in]
 *     ssusb: ssusb mtk structure
 * @param[in]
 *     to_host: to host
 * @return
 *     none
