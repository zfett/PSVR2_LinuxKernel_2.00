 ...
 * @file mtu3_gadget.c
 *
 *  USB API for MediaTek usb3 DRD peripheral support
 *
 */
 ...
 * @par Description
 *     MTK USB request complete.
 * @param[out]
 *     mep: mtu3 end point structure
 * @param[in]
...
static int mtu3_ep_enable(struct mtu3_ep *mep)
{
	...
	int max_packet;
	int ret;
	int mtu3_u3_in_ep_slot[16] = { 0,
				CONFIG_USB_MTU3_U3_IN_EP1_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP2_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP3_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP4_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP5_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP6_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP7_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP8_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP9_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP10_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP11_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP12_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP13_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP14_SLOT_NUM,
				CONFIG_USB_MTU3_U3_IN_EP15_SLOT_NUM,
	};

	int mtu3_u3_out_ep_slot[9] = { 0,
				CONFIG_USB_MTU3_U3_OUT_EP1_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP2_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP3_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP4_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP5_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP6_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP7_SLOT_NUM,
				CONFIG_USB_MTU3_U3_OUT_EP8_SLOT_NUM,
	};
	...
	if (mtu->g.speed >= USB_SPEED_SUPER) {
		if (mep->is_in)
			mep->slot = usb_endpoint_xfer_int(desc) ?
					0 : mtu3_u3_in_ep_slot[mep->epnum];
		else
			mep->slot = usb_endpoint_xfer_int(desc) ?
					0 : mtu3_u3_out_ep_slot[mep->epnum];
	} else
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget operation for end point enable.
 * @param[in]
 *     ep: device side representation of USB endpoint structure.
 * @param[in]
 *     desc: Endpoint descriptor structure
 * @return
 *     0, means SUCCESS.\n
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget operation for end point disable.
 * @param[in]
 *     ep: device side representation of USB endpoint structure.
 * @return
 *     0, means SUCCESS.
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget allocate request.
 * @param[in]
 *     ep: device side representation of USB endpoint structure
 * @param[in]
 *     gfp_flags: the type of memory to allocate
 * @return
 *     &mreq->request, point of usb request structure.\n
 *     NULL, means fail.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 ...
 *     ep: device side representation of USB endpoint structure
 * @param[in]
 *     value: sets the endpoint halt feature
 * @return
 *     0, means SUCCESS.\n
 *     -EINVAL, Invalid argument.\n
 *     -EAGAIN, Try again.\n
 ...
 * @return
 *     -EINVAL, Invalid argument.\n
 *     usb_ep_set_halt, return come from EP set halt function.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget get frame.
 * @param[in]
 *     gadget: usb gadget structure
 * @return
 *     USB2 FRAME number.\n
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget set self powered.
 * @param[in]
 *     gadget: usb gadget structure
 * @param[in]
 *     is_selfpowered: flag for self powered
 * @return
 *     0, means SUCCESS.
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget start.
 * @param[in]
 *     gadget: usb gadget structure
 * @param[in]
 *     driver: usb gadget driver structure
 * @return
 *     0, means SUCCESS.
 ...
 *     USB stop activity.
 * @param[in]
 *     mtu: device driver instance data structure
 * @return
 *     none
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     mtu3 match EP number.
 * @param[in]
 *     _gadget: usb_gadget structure
  * @param[in]
 *     desc: usb usb_endpoint_descriptor structure
 * @param[in]
 *     ep_comp: usb usb_ss_ep_comp_descriptor structure
 * @return
 *     ep, means SUCCESS.
 *     NULL, means EP not match.
 * @par Boundary case and limitation
 *     none
 * @par Error case and Error handling
 *     none
 ...
 * @par Refer to the source code
 */
static struct usb_ep *mtu3_gadget_match_ep(struct usb_gadget *_gadget,
...
static const struct usb_gadget_ops mtu3_gadget_ops = {
	...
	.match_ep = mtu3_gadget_match_ep,
};

/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB initial hardware end point.
 * @param[out]
 *     mtu: mtu3 structure
 * @param[out]
 *     mep: mtu3 end point structure
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget initial end points.
 * @param[out]
 *     mtu: mtu3 structure
 * @return
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget setup.
 * @param[out]
 *     mtu: usb gadget structure
 * @return
 *     0, means SUCCESS.\n
 *     ret, if return value isn't 0, means FAIL.
 * @par Boundary case and limitation
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     MTK USB gadget cleanup.
 * @param[out]
 *     mtu: structure mtu3, device driver instance data
 * @return
 *     none
 * @par Boundary case and limitation
 *     none
...
/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     called when init mtu3 parameter.
 * @param[out]
 *     mtu: structure mtu3, device driver instance data
 * @return
 *     none
 ...
 * @par Refer to the source code
 */
void mtu3_init_parameter(struct mtu3 *mtu)
{
	mtu->address = 0;
...
void mtu3_gadget_disconnect(struct mtu3 *mtu)
{
	...
	mtu3_init_parameter(mtu);
	usb_gadget_set_state(&mtu->g, USB_STATE_NOTATTACHED);
}

/** @ingroup IP_group_usb_internal_function
 * @par Description
 *     called when Host send reset.
 * @param[out]
 *     mtu: structure mtu3, device driver instance data
 * @return
 *     none
